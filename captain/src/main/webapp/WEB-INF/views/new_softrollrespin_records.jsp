    ...
    <div class="container-fluid">
      <div class="row">
       <!--  <div class="col-sm-9 col-sm-offset-1 col-md-10 col-md-offset-1 main"> -->
          ...
          <form class="form-signin" action="./record/insertsoftrollrespins.action" method="post">				      				      	
					      ...
					      <td>							    
							<div class="form-group">
							    <label for="name">Chassis</label>
							   	<select class="form-control" id="chassis0" name="SoftrollRespinVos[0].chassis"></select>	
							</div>
					      </td>
					      <td>
					      	<div class="form-group">
							    <label for="name">Platform</label>
							    <select class="form-control" id="platform0" name="SoftrollRespinVos[0].platform"></select>								    
							</div>
					      </td>
					       <td>
					      	<div class="form-group">
							    <label for="name">Test Function</label>									  
								<select class="form-control" name="SoftrollRespinVos[0].test_function">
							      <option value="FIT">FIT</option>
							      <option value="WAT">WAT</option>
							      <option value="Stress">Stress</option>
							      <option value="HWQA">HWQA</option>
					       ...
					       <td>
					      	<div class="form-group">
							    ...
							    <input  id="schedule0" class="form-control" name="SoftrollRespinVos[0].schedule"/>
					      ...
					      <td>
					      	<div class="form-group">
							   <label for="name">BIOS Version</label>							 
							   	<input id="bios_version0" class="form-control"  name="SoftrollRespinVos[0].bios_version"/>							   			    
							</div>
					      </td>
					      <td>
					      	<div class="form-group">
							    <label for="name">Image Build ID</label>
							    <input class="form-control" name="SoftrollRespinVos[0].image_build_id"/>					    
							</div>
					      </td>
					       <td>
					      	<div class="form-group">
							    <label for="name">Test Plan</label>
							    <input class="form-control"  name="SoftrollRespinVos[0].test_plan"/>					    
							</div>
					      </td>
					       <td>
					      	<div class="form-group">
							    <label for="name">Tester</label>									  
								 <input class="form-control" name="SoftrollRespinVos[0].tester"/>					    
							</div>
					      </td>
					    </tr>
				  	</tbody>
...
/* ----------Add & Minus------------------ */
 ...
 /* ----------Add -------------------------- */	    	 
	    	 ...
	    	 function createRow(common_chassises0){	
	    		 ...
	    		 row_content +='<select class="form-control" id="chassis'+add_clicks+'" name="SoftrollRespinVos['+add_clicks+'].chassis"></select>';
	    		 row_content +='</div></td>';
	    		
	    		 
	    		 //TD:platform
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<select class="form-control" id="platform'+add_clicks+'" name="SoftrollRespinVos['+add_clicks+'].platform"></select>';
	    		 row_content +='</div></td>';
	    		 ...
	    		 //TD:test_function
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<select class="form-control" id="test_function'+add_clicks+'" name="SoftrollRespinVos['+add_clicks+'].test_function">';
	    		 row_content +='<option value="FIT">FIT</option>';
	    		 row_content +='<option value="WAT">WAT</option>';
	    		 row_content +='<option value="Stress">Stress</option>';
	    		 row_content +='<option value="HWQA">HWQA</option>';
	    		 row_content +='<option value="Benchmark">Benchmark</option>';
	    		 row_content +='<option value="SWT">SWT</option>';
	    		 ...
	    		 //TD:schedule
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<input class="form-control" id="schedule'+add_clicks+'" name="SoftrollRespinVos['+add_clicks+'].schedule"></input>';
	    		 row_content +='</div></td>';
	    		
	    		 
	    		 //bios_version
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<input class="form-control" id="bios_version'+add_clicks+'" name="SoftrollRespinVos['+add_clicks+'].bios_version"></input>';
	    		 row_content +='</div></td>';
	    		 
	    		 //image_build_id
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<input class="form-control" id="image_build_id'+add_clicks+'" name="SoftrollRespinVos['+add_clicks+'].image_build_id"></input>';
	    		 row_content +='</div></td>';
	    		 
	    		 //test_plan
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<input class="form-control" id="test_plan'+add_clicks+'" name="SoftrollRespinVos['+add_clicks+'].test_plan"></input>';
	    		 row_content +='</div></td>';
	    		 
	    		 //tester
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<input class="form-control" id="tester'+add_clicks+'" name="SoftrollRespinVos['+add_clicks+'].tester"></input>';
	    		 row_content +='</div></td>';
