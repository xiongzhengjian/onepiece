...
public class DateUtils_origin {
    ...
    public static String dateFormat(Date date, String pattern) throws ParseException{
        if(StringUtils.isEmpty(pattern)){
            pattern = DateUtils_origin.DATE_PATTERN;
        }
    ...
    public static String dateTimeToDateString(Date dateTime) throws ParseException{
        String dateTimeString = DateUtils_origin.dateFormat(dateTime, DateUtils_origin.DATE_TIME_PATTERN);  
