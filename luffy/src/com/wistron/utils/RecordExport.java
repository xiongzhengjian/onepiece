...
public class RecordExport {
	...
	//private ExportRecordDaoImpl  daoImple = new ExportRecordDaoImpl();
...
/*================== 2.commodity ===================  */
		...
		List<Commodity> commoditydata = daoImple.findAllCommodity();
...
/*================== 3.Softpaq ===================  */
      ...
      //get data from database
		List<Softpaq> softpaqdata = daoImple.findAllSoftpaq();
...
/*================== 4.Wat ===================  */
      ...
      //get data from database
		List<Wat> watdata = daoImple.findAllWat();
...
/*================== 5.image softroll&respin ===================  */
        ...
        //get data from database
		List<SoftrollRespin> softrollrespindata = daoImple.findAllSoftrollrespin();
