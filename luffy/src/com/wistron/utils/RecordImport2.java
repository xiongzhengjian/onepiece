...
public class RecordImport2 {
	...
	private ExcelRecordDaoImpl dao = new ExcelRecordDaoImpl();
...
//					System.out.println(newDataList);
					...
					dao.insertBioses(new_bios_list);
				}
...
//					System.out.println(newDataList);
					...
					//Insert the data into the database
					dao.insertCommodities(new_commodity_list);
...
//					System.out.println(newDataList);
					...
					//Insert the data into the database
					dao.insertSoftpaq2(new_softpaq_list);
				}
