...
public class Softpaq2 {
	...
	private String products_sequence;
	private String mark;
	...
	public Softpaq2(String owner, Date start, Date end, String sp_number, String softpaq_title, String version,
			...
			String products_sequence, String mark) {
		super();
		this.owner = owner;
		this.start = start;
		this.end = end;
	...
	public Softpaq2(int softpaq_id, String owner, Date start, Date end, String sp_number, String softpaq_title,
			...
			String function_status, String products_sequence, String mark) {
		super();
	...
	public String getProducts_sequence() {
		return products_sequence;
	}

	public void setProducts_sequence(String products_sequence) {
		this.products_sequence = products_sequence;
	}
