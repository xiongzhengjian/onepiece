    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">       
          ...
          <form id="paging" method="post" action="./record/sfrpageshow.action">
            <table class="table table-condensed table-bordered">
            <caption>Image Softroll&Respin Record</caption>
              <thead>
                <tr>
                  <th>Chassis</th>                  
                  <th>Platform</th>
              			...
              			<c:if test="${pagebean.totalPage>1 && pagebean.currentPage == 1}">
							<ul class="pagination">
								<c:forEach begin="${pagebean.pageRangeStart}" end="${pagebean.pageRangeEnd}" step="1" var="i">    
									<li><a href="./record/sfrpaging.action?currentPage=${i }">${i }</a></li>
								 </c:forEach>
								 
								<li><a href="./record/sfrpaging.action?currentPage=${pagebean.currentPage+1 }">&raquo;</a></li>
								<li><a href="./record/sfrpaging.action?currentPage=${pagebean.totalPage }">End</a></li>
							</ul>
						 </c:if> 
						 
              			<c:if test="${pagebean.totalPage>1 && pagebean.currentPage == pagebean.totalPage}">
              				<ul class="pagination">
								<li><a href="./record/sfrpaging.action?currentPage=1">Start</a></li>
						    	<li><a href="./record/sfrpaging.action?currentPage=${pagebean.currentPage-1 }">&laquo;</a></li>
