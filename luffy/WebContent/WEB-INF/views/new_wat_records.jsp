    ...
    <div class="container-fluid">
      <div class="row">
       <!--  <div class="col-sm-9 col-sm-offset-1 col-md-10 col-md-offset-1 main"> -->
          ...
          <form class="form-signin" action="./record/insertwats.action" method="post">				      				      	
					    ...
					    <tr id="trs0">
					      <td>							    
							<div class="form-group">
							    <label for="name">Chassis</label>
							   	<select class="form-control" id="chassis0" name="WatVos[0].chassis"></select>	
							</div>
					      </td>
					      <td>
					      	<div class="form-group">
							    <label for="name">Platform</label>
							    <select class="form-control" id="platform0" name="WatVos[0].platform"></select>								    
							</div>
					      </td>
					      <td>
					      	<div class="form-group">
							    <label for="name">Device Name</label>
							    <input  id="name0" class="form-control" name="WatVos[0].device_name"/>
					      ...
					      <td>
					      	<div class="form-group">
							    ...
							    <input  id="name0" class="form-control" name="WatVos[0].pn_sn"/>
					       ...
					       <td>
					      	<div class="form-group">
							    ...
							    <input  id="schedule0" class="form-control" name="WatVos[0].schedule"/>
					      ...
					      <td>
					      	<div class="form-group">
							   <label for="name">BIOS Version</label>							 
							   	<input id="bios_version0" class="form-control"  name="WatVos[0].bios_version"/>							   			    
							</div>
					      </td>
					      <td>
					      	<div class="form-group">
							    <label for="name">Image Build ID</label>
							    <input class="form-control" name="WatVos[0].image_build_id"/>					    
							</div>
					      </td>
					       <td>
					      	<div class="form-group">
							    <label for="name">Test Plan</label>
							    <input class="form-control"  name="WatVos[0].test_plan"/>					    
							</div>
					      </td>
					       <td>
					      	<div class="form-group">
							    <label for="name">Tester</label>									  
								 <input class="form-control" name="WatVos[0].tester"/>					    
							</div>
					      </td>
					    </tr>
				  	</tbody>
...
/* ----------Add & Minus------------------ */
 ...
 /* ----------Add -------------------------- */	    	 
	    	 ...
	    	 function createRow(common_chassises0){	
	    		 ...
	    		 row_content +='<select class="form-control" id="chassis'+add_clicks+'" name="WatVos['+add_clicks+'].chassis"></select>';
	    		 row_content +='</div></td>';
	    		
	    		 
	    		 //TD:platform
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<select class="form-control" id="platform'+add_clicks+'" name="WatVos['+add_clicks+'].platform"></select>';
	    		 row_content +='</div></td>';
	    		
	    		 
	    		 //TD:device_name
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<input class="form-control" id="device_name'+add_clicks+'" name="WatVos['+add_clicks+'].device_name"></input>';
	    		 row_content +='</div></td>';
	    		//console.log(row_content);
	    		 ...
	    		 //TD:pn_sn
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<input class="form-control" id="pn_sn'+add_clicks+'" name="WatVos['+add_clicks+'].pn_sn"></input>';
	    		 row_content +='</div></td>';
	    		 ...
	    		 //TD:schedule
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<input class="form-control" id="schedule'+add_clicks+'" name="WatVos['+add_clicks+'].schedule"></input>';
	    		 row_content +='</div></td>';
	    		
	    		 
	    		 //bios_version
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<input class="form-control" id="bios_version'+add_clicks+'" name="WatVos['+add_clicks+'].bios_version"></input>';
	    		 row_content +='</div></td>';
	    		 
	    		 //image_build_id
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<input class="form-control" id="image_build_id'+add_clicks+'" name="WatVos['+add_clicks+'].image_build_id"></input>';
	    		 row_content +='</div></td>';
	    		 
	    		 //test_plan
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<input class="form-control" id="test_plan'+add_clicks+'" name="WatVos['+add_clicks+'].test_plan"></input>';
	    		 row_content +='</div></td>';
	    		 
	    		 //tester
	    		 row_content +='<td><div class="form-group">';
	    		 row_content +='<input class="form-control" id="tester'+add_clicks+'" name="WatVos['+add_clicks+'].tester"></input>';
	    		 row_content +='</div></td>';
