      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <form method="POST" enctype="multipart/form-data" id="form1" action="./record/import.action"">  
            ...
            <input type=hidden value="wat" name="category">
              ...
              <tbody>
              	<c:forEach items="${vos}" varStatus="idStatus" var="vo" > 
                	<tr id="tr${idStatus.index+0 }">               		
            			...
            			<td>${vo.tester }</td>            			          			
            			<td>
            				<a class="label label-info  edit" title="${vo.wat_id }" id="${idStatus.index+0 }">edit</a>
            				<a class="label label-warning  delete" title="${vo.wat_id }" id="${idStatus.index+0 }">delete</a>
            			</td>  
        			</tr>
        		</c:forEach> 
              </tbody>
